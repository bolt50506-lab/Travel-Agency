...
const configs: Record<string, { table: string; fields: string[]; search: string[] }> = {
  ...
  umrah_packages: { table: 'umrah_packages', fields: ['name','short_description','badge','image_url','makkah_hotel','madinah_hotel','transport','visa_included','flights_included','ziyarat_included','duration_days','makkah_nights','madinah_nights','room_sharing','price_per_pilgrim','currency','departure_date','return_date','seats','is_active'], search: ['name','makkah_hotel','madinah_hotel','transport'] },
